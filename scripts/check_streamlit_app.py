"""Visita pública de San Pedro; comprueba la interfaz, no sólo una respuesta HTTP.
...
APP_URL = "https://c2opkuvqsydq8s8m2crsnk.streamlit.app/"
HEADING = "Gemelo Digital · Lolium San Pedro"
            ...
            while time.monotonic() - started < MAX_WAIT_SECONDS:
                ...
                if ready:
                    if ready_since is None:
                        ...
                        return f"San Pedro operativo: indicadores y gráfico cargados ({seconds} s)."
                else:
                    ready_since = None
